...
public class Execution {
  ...
  @Option(gloss="Add log.note to the exec directory name (when using useStandardExecPoolDirStrategy")
  public static boolean addNoteToExecDirName = false;
  ...
  public static String createVirtualExecDir() {
    ...
    for(int i = 0; numFailures < 3; i++) {
      ...
      final String execDirSuffix = ((addNoteToExecDirName && !StrUtils.isEmpty(LogInfo.note)) ? ("." + LogInfo.note) : "") + ".exec";
  ...
  public static String getFile(String file) {
		if (!isVirtualExecDirSet()) return file;
